...
async function requestWithRetry<T>(
  ...
  for (let attempt = 1; attempt <= retries; attempt++) {
    try {
      ...
      console.warn(
        `⚠️ 请求失败 (${attempt}/${retries})，${delay / 1000}s 后重试...`,
      );
...
class YahooFinanceProvider implements PriceProvider {
  private readonly cnStocks: Array<{
    symbol: string;
    name: string;
    pinyin: string;
  }> = [
    ...
    // 能源·资源
    {
      symbol: "601857.SS",
      name: "中国石油",
      pinyin: "zhongguo shiyou petrochina",
    },
    {
      symbol: "600028.SS",
      name: "中国石化",
      pinyin: "zhongguo shihua sinopec",
    },
    ...
    { symbol: "600690.SS", name: "海尔智家", pinyin: "haier zhijia" },
    {
      symbol: "601888.SS",
      name: "中国中免",
      pinyin: "zhongguo zhongmian cdfg",
    },
    // 制造·工业
    ...
    { symbol: "601012.SS", name: "隆基绿能", pinyin: "longji lvneng longi" },
    {
      symbol: "688599.SS",
      name: "天合光能",
      pinyin: "tianhe guangneng trinasolar",
    },
    {
      symbol: "688223.SS",
      name: "晶科能源",
      pinyin: "jingke nengyuan jinkosolar",
    },
    // 半导体·科技
    { symbol: "688012.SS", name: "中微公司", pinyin: "zhongwei gongsi amec" },
    {
      symbol: "688036.SS",
      name: "传音控股",
      pinyin: "chuanyin konggu transsion",
    },
    ...
    { symbol: "600703.SS", name: "三安光电", pinyin: "sanan guangdian" },
    {
      symbol: "603986.SS",
      name: "兆易创新",
      pinyin: "zhaoyi chuangxin gigadevice",
    },
    {
      symbol: "688111.SS",
      name: "金山办公",
      pinyin: "jinshan bangong wps kingsoft",
    },
    ...
    // 交运·物流
    {
      symbol: "601919.SS",
      name: "中远海控",
      pinyin: "zhongyuan haikong cosco",
    },
    {
      symbol: "601111.SS",
      name: "中国国航",
      pinyin: "zhongguo guohang airchina",
    },
    ...
    // 科技·半导体
    {
      symbol: "002415.SZ",
      name: "海康威视",
      pinyin: "haikang weishi hikvision",
    },
    ...
    { symbol: "000063.SZ", name: "中兴通讯", pinyin: "zhongxing tongxun zte" },
    {
      symbol: "002371.SZ",
      name: "北方华创",
      pinyin: "beifang huachuang naura",
    },
    ...
    { symbol: "002236.SZ", name: "大华股份", pinyin: "dahua gufen dahua" },
    {
      symbol: "002179.SZ",
      name: "中航光电",
      pinyin: "zhonghang guangdian jonhon",
    },
    // 医药
    ...
    { symbol: "300750.SZ", name: "宁德时代", pinyin: "ningde shidai catl" },
    {
      symbol: "300274.SZ",
      name: "阳光电源",
      pinyin: "yangguang dianyuan sungrow",
    },
    ...
    // 创业板·科技
    {
      symbol: "300059.SZ",
      name: "东方财富",
      pinyin: "dongfang caifu eastmoney",
    },
    {
      symbol: "300124.SZ",
      name: "汇川技术",
      pinyin: "huichuan jishu inovance",
    },
    ...
    { symbol: "300347.SZ", name: "泰格医药", pinyin: "taige yiyao tigermed" },
    {
      symbol: "300759.SZ",
      name: "康龙化成",
      pinyin: "kanglong huacheng pharmaron",
    },
    ...
    // 传媒
    {
      symbol: "002027.SZ",
      name: "分众传媒",
      pinyin: "fenzhong chuanmei focus",
    },
    ...
    { symbol: "1299.HK", name: "友邦保险", pinyin: "youbang baoxian aia" },
    {
      symbol: "0388.HK",
      name: "香港交易所",
      pinyin: "xianggang jiaoyisuo hkex",
    },
    ...
    { symbol: "0728.HK", name: "中国电信(港)", pinyin: "zhongguo dianxin hk" },
    {
      symbol: "0883.HK",
      name: "中国海洋石油",
      pinyin: "zhongguo haiyang shiyou cnooc",
    },
    // 消费·零售
    ...
    { symbol: "1093.HK", name: "石药集团", pinyin: "shiyao jituan cspc" },
    {
      symbol: "1177.HK",
      name: "中国生物制药",
      pinyin: "zhongguo shengwu zhiyao sino biopharma",
    },
    // 半导体
    ...
    { symbol: "1109.HK", name: "华润置地", pinyin: "huarun zhidi cr land" },
    {
      symbol: "1209.HK",
      name: "华润万象生活",
      pinyin: "huarun wanxiang shenghuo cr mixc",
    },
  ...
  async searchSymbols(
    ...
    const localResults = this.cnStocks
      .filter(
        (s) =>
          s.name.includes(q) ||
          s.pinyin.includes(q) ||
    ...
    try {
      ...
      console.error(
        `Yahoo Finance 搜索失败: status=${status ?? "unknown"} msg=${msg} query="${query}"`,
      );
      return [];
    }
  }
...
export class PriceService {
  ...
  // 批量获取价格
  async getPrices(
    assets: Array<{ type: AssetType; symbol: string }>,
